...
/**
 * Created by computer on 2018/5/24.
 * 实现保存状态的 Fragment
 */
...
//                ft.commit();
    ...
    @Nullable
    public FragmentTransaction doTabChanged(@Nullable String tag,
        ...
        if (mLastTab != newTab) {
            ...
            if (mLastTab != null) {
                if (mLastTab.fragment != null) {
                    LogUtils.i(TAG, mLastTab.tag + "hide");
                    ft.hide(mLastTab.fragment);
//                    if(mLastTab.fragment instanceof BaseFragment){
//                        LogUtils.i("xxhd", "mLastTab.fragment instanceof BaseFragment");
//                        BaseFragment fragment = (BaseFragment) mLastTab.fragment;
...
//                    }
            ...
            if (newTab != null) {
                if (newTab.fragment == null) {
                    ...
                    // TODO mFragment 添加 fragment
                    LogUtils.i(TAG, "当前Fragment：" + newTab.fragment);
                    if(!mFragments.contains(newTab.fragment)){
                        mFragments.add(newTab.fragment);
                        LogUtils.i(TAG, "add fragment");
                    }
                } else {
                    LogUtils.i(TAG, tag + "show");
                    ft.show(newTab.fragment);
//                    if(mLastTab.fragment instanceof BaseFragment){
//                        LogUtils.i("xxhd", "newTab.fragment instanceof BaseFragment");
//                        BaseFragment fragment = (BaseFragment) newTab.fragment;
