...
public class MProgressBarDialog {
    ...
    private void configView() {
        ...
        myGrad.setStroke(DpUtils.dp2px(mContext, mBuilder.strokeWidth), mBuilder.strokeColor);
        myGrad.setCornerRadius(DpUtils.dp2px(mContext, mBuilder.cornerRadius));
        ...
        progressBarBackgroundDrawable.setCornerRadius(DpUtils.dp2px(mContext, mBuilder.progressCornerRadius));
        //二级进度条
        ...
        secondProgressDrawable.setCornerRadius(DpUtils.dp2px(mContext, mBuilder.progressCornerRadius));
        ...
        progressDrawable.setCornerRadius(DpUtils.dp2px(mContext, mBuilder.progressCornerRadius));
        ...
        layoutParams.height = DpUtils.dp2px(mContext, mBuilder.horizontalProgressBarHeight);
        ...
        circularProgressBar.setProgressBarWidth(DpUtils.dp2px(mContext, mBuilder.circleProgressBarWidth));
        circularProgressBar.setBackgroundProgressBarWidth(DpUtils.dp2px(mContext, mBuilder.circleProgressBarBackgroundWidth));
